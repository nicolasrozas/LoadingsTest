...
public class FasterAnimationsContainer{
    ...
    public static FasterAnimationsContainer getInstance(ImageView imageView,Context context) {
        if (sInstance == null)
    ...
    private class FramesSequenceAnimation implements Runnable{
        ...
        public void run() {
            ...
            if (imageView.isShown()) {
                ...
                GetImageDrawableTask task = new GetImageDrawableTask(imageView,mContext);
